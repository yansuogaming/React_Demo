...
use Vietiso\Core\Http\File\Exception\CannotWriteFileException;
use Vietiso\Core\Http\File\Exception\ExtensionFileException;
use Vietiso\Core\Http\File\Exception\FileException;
use Vietiso\Core\Http\File\Exception\FormSizeFileException;
use Vietiso\Core\Http\File\Exception\IniSizeFileException;
use Vietiso\Core\Http\File\Exception\NoFileException;
use Vietiso\Core\Http\File\Exception\NoTmpDirFileException;
use Vietiso\Core\Http\File\Exception\PartialFileException;
use Vietiso\Core\Http\File\Exception\FileNotFoundException;
...
class UploadedFile extends File
{
    ...
    {
        if ($this->isValid()) {
            $directory = storage_path(join_paths('public', $directory));
            ...
            $target = $this->getTargetFile(
                $directory,
                $name ?? uniqid() . '.' . pathinfo($this->originalName, PATHINFO_EXTENSION)
            );
            ...
            return str_replace(storage_path(), '', $target);
        }
