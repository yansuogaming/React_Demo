        ...
        <HeaderContext.Provider value={contextValue}>
            <header>
                ...
                <div className="lg:hidden flex items-center justify-between px-[14px] py-[12px] relative z-1">
                    ...
                    <div className="w-full h-screen fixed top-0 left-0 bg-[#003F73] text-[#fff]">
                        ...
                        <div className="flex flex-col justify-between pt-[50px] px-[16px] pb-[16px]">
                            <ul className="flex items-center gap-[5px]">
                                <li>
                                    <NavLink
                                        to="/"
                                        className="text-[10px] font-bold flex items-center gap-[10px]"
                                    >
