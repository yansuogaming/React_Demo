    ...
    return (
        <section {...props} className={cn("container", className)}>
            ...
            <div className="text-center">
                ...
                <ul className="inline-flex items-center justify-center gap-[46px] rounded-[80px] bg-white shadow-[0px_4px_12px_0px_rgba(54,133,143,0.15)] px-[70px] py-[16px] pb-[20px] mb-[66px]">
                    {[
                        ...
                        <li
                            ...
                            className={
                                activeRegion === index ? "active_region" : ""
                            }
                        >
                ...
                {/* <ul className="inline-flex items-center justify-center gap-[46px] rounded-[80px] bg-white shadow-[0px_4px_12px_0px_rgba(54,133,143,0.15)] px-[70px] py-[16px] pb-[20px] mb-[66px] text-[#494951] text-[18px] font-[400]">
                    <li className="relative hnv_region_active">
