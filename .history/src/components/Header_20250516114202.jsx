    ...
    return (
        <HeaderContext.Provider value={contextValue}>
            <header>
                ...
                <div className="flex items-center justify-between px-[14px] py-[12px] relative">
                    <div
                        className="absolute w-full h-[100px] top-0 left-0 bg-gradient-to-b from-[rgba(4,18,58,0.40)] via-[rgba(4,18,58,0.25)] to-[rgba(4,18,58,0.00)]
"
                    ></div>
                    {/* Logo */}
                    <motion.div
