...
const RegionList = ({ className, ...props }) => {
    ...
    const regions = [
        ...
        },
        {
            ...
            description:
                "The Spratly Islands (Quần đảo Trường Sa) are a vast archipelago in the South China Sea, consisting of over 100 islands, reefs, and submerged features. Located approximately 480 km from Vietnam’s Cam Ranh Peninsula, the islands hold strategic importance and are a symbol of Vietnam’s maritime sovereignty2. Despite their remote location and harsh climate, some islands have been developed with infrastructure, including military outposts and small communities. The Spratly Islands are also known for their rich marine biodiversity and play a crucial role in regional geopolitics.",
