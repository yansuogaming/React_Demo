...
const RegionList = ({ className, ...props }) => {
    ...
    const regions = [
        { id: 0, component: <NorthImage />, position: "" },
        {
            id: 1,
            component: <CentralImage />,
            position: "translate-x-[69px] translate-y-[-32px]",
        },
        {
            id: 2,
            component: <SouthImage />,
            position: "translate-x-[93px] translate-y-[-44px]",
        },
        {
            id: 3,
            component: <ParacelIslands />,
            position: "absolute top-[282px] right-[82px]",
        },
        {
            id: 4,
            component: <SpratlyIslands />,
            position: "absolute top-[528px] right-[12px]",
        },
    ];
    return (
            ...
            <div className="flex flex-col lg:flex-row items-center gap-[35px]">
                ...
                <div className="hidden lg:block min-w-[512px] relative h-fit">
                    {regions.map((region) => (
                        <div
                            key={region.id}
                            className={region.position}
                            onClick={() => setActiveRegion(region.id)}
                        >
                            {React.cloneElement(region.component, {
                                className: `${
