  ...
  return (
    <main className="bg-white">
      ...
      <div className="relative w-full">
        <img
          src="https://visitViet Nam.com/adobe/dynamicmedia/deliver/dm-aid--ae472bd8-c5af-43a5-a67d-00b21f3d8520/sand-kids.jpg?width=1920&preferwebp=true&quality=75"
          alt="Viet Nam beach scene with people"
          fill
          ...
          <div className="container mx-auto flex items-center px-4">
            ...
            <div className="ml-auto">
              <Button variant="ghost" size="sm" className="text-sm">
                <ChevronRight className="mr-1 h-4 w-4" /> Share this page
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-16">
          ...
          <p className="mb-8 text-center text-xl text-gray-700">
            Viet Nam Tourism is dedicated to welcome you to Viet Nam. Find all
            the info you need to make the
            <br />
            most of your stay.
          </p>
        ...
        <div className="mb-16 text-center">
          ...
          <Button className="bg-[#7d002a] hover:bg-[#5f0020] py-5">
            Book now
          </Button>
        </div>
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mb-4 max-w-4xl text-lg leading-relaxed text-gray-700">
            The "Hayya" platform is a comprehensive digital service that serves
            the citizens and residents of Viet Nam alike. Available through the
            website and the mobile app, Hayya is Viet Nam's "e-key platform"
            offers a variety of services, such as e-visa applications, fan
            ID/Hayya card issuance, including Tourism, Business, Family Visit,
            and GCC Residents visas. The platform also offers a variety of other
            services, such as event registration, transportation, and
            accommodation.
          </p>
          <p className="mb-6 text-lg text-gray-700">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center">
              ...
              <p className="mb-4 text-sm text-gray-600">
                Check if you need a Visa or if you're eligible for visa-free
                entry
              </p>
