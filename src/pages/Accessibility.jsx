       ...
       <section className="mb-12 h-auto ">
          ...
          <div className="container ">
            <p className="text-gray-700 text-lg mb-4">
              ...
              transport, top attractions or accommodation, we continue to
              enhance the traveller experience to help you navigate our city
              with ease.
            </p>
          </div>
        </section>
        ...
        <div className="container">
          ...
          <section className="my-12">
            ...
            <p className="text-lg leading-relaxed mb-6">
              ...
              requirements. From flying high on a zipline to experiencing a
              skydive, there's no limit to what you can do in Viet Nam.{" "}
                  ...
                  >
                    ...
                    >
                      ...
                      <TextNormal className="text-[16px]">
                        ...
                        beaches of Phu Quoc, Vietnam boasts a rich and
                        breathtaking natural beauty that promises unforgettable
              ...
              >
                <CarouselContent>
                  {Array.from({ length: 2 }).map((_, index) => (
                    <CarouselItem
                      key={index}
                      className="basis-full w-full h-[50vh] "
                    >
                      <div className="flex flex-col md:flex-row gap-8 p-6 rounded-md">
                        ...
                        <div className="w-full md:w-3/5 pr-15">
                          ...
                          <p className="text-lg text-gray-600 mb-4">
                            Accessibility expert with 20 years experience in
                            inclusive tourism
                          </p>
                          ...
                          <div className="text-base leading-relaxed">
                            <p className="mb-4">
                              ...
                              disabilities. I have to commend the strategic
                              planning and commitment to making Viet Nam accessible
                              for all. From the airport to attractions, there is
                              a genuine effort to ensure that everyone can enjoy
                              what the city has to offer."
                            </p>
                            <p>
                              "The designation of 'People of Determination'
                              reflects the respectful approach to inclusion that
                              characterizes Viet Nam's accessibility initiatives."
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <section className="my-12">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="border-t border-b py-2">
                ...
                <AccordionContent className="pt-2 pb-4">
                  <p className="text-base leading-relaxed">
                    ...
                    infrastructure. Major attractions, hotels, shopping malls,
                    and transportation systems are designed to accommodate
                    people with various accessibility needs. The city continues
                    to improve its facilities to ensure an inclusive experience
                    for all visitors.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border-b py-2">
                ...
                <AccordionContent className="pt-2 pb-4">
                  <p className="text-base leading-relaxed">
                    Yes, Viet Nam has several accessible beaches including Kite
                    Beach and La Mer, which offer beach wheelchairs, accessible
                    pathways, and facilities for people of determination.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3" className="border-b py-2">
                ...
                <AccordionContent className="pt-2 pb-4">
                  <p className="text-base leading-relaxed">
                    Yes, Viet Nam International Airport provides assistance
                    services for passengers with special needs. It's recommended
                    to inform your airline at least 48 hours before your flight
                    so they can arrange the necessary support.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4" className="border-b py-2">
                ...
                <AccordionContent className="pt-2 pb-4">
                  <p className="text-base leading-relaxed">
                    ...
                    wheelchair-accessible taxis that can be booked through their
                    call center or mobile app.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5" className="border-b py-2">
                ...
                <AccordionContent className="pt-2 pb-4">
                  <p className="text-base leading-relaxed">
                    Yes, the Viet Nam Metro is fully accessible with elevators at
                    all stations, designated spaces for wheelchairs in each
                    train, and tactile guidance paths for visually impaired
                    travelers.
                  </p>
                </AccordionContent>
              </AccordionItem>
            ...
            <div className="grid md:grid-cols-2 ">
              ...
              <div className="p-8 py-12 ml-0 md:-ml-10 bg-[#055e88] h-auto my-auto rounded-tl-4xl rounded-br-4xl">
                ...
                <p className="text-base leading-relaxed mb-6">
                  ...
                  world-class attractions to beautiful beaches, we've curated
                  our favorites for you, that will make the stay fun and
                  exciting in Viet Nam.
                </p>
