            ...
            <div className="grid grid-cols-3 gap-[30px]">
                <div className="rounded-[60px_4px_4px_4px] p-[30px] bg-[#F5F6FA] text-center">
                    ...
                    <div className="flex gap-[12px] items-center justify-center mb-[5px]">
                        ...
                        <p className="text-[48px] text-[#1A2A44] font-bold font-[Roboto]">31,9°C</p>
                    </div>
                    <p className="text-[#494951] font-normal text-[16px] mb-[30px]">Cloudy</p>
                    <table className="w-full text-[#1A2A44] text-[16px] font-medium">
                        <tbody>
                            <tr>
                ...
                <div className="rounded-[4px] p-[30px] bg-[#F5F6FA]">
                    <h3 className="mb-[30px] text-[#1A2A44] text-[16px] font-bold text-left">
                        BEST TIME TO VISIT
                    </h3>
                ...
                <div className="rounded-[4px_4px_60px_4px] p-[30px] bg-[#F5F6FA]">
                    <h3 className="mb-[30px] text-[#1A2A44] text-[16px] font-bold text-left">
                        TRANSPORTATION
                    </h3>
