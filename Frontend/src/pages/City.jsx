            ...
            <section className="container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-[32px]">
                    <div className="lg:col-span-2">
                        ...
                        <div
                            className={`text-[#1A2A44] text-[16px] lg:text-[18px] prose ${
                                tab === "welcome" ? "" : "hidden"
                            }`}
                        ...
                        <div
                            className={`text-[#1A2A44] text-[16px] lg:text-[18px] prose ${
                                tab === "getting_to" ? "" : "hidden"
                            }`}
                            dangerouslySetInnerHTML={{
                                __html: city.content_getting_to,
                            }}
                        ></div>
                        <div
                            className={`text-[#1A2A44] text-[16px] lg:text-[18px] prose ${
                                tab === "when_to_visit" ? "" : "hidden"
                            }`}
                            dangerouslySetInnerHTML={{
                                __html: city.content_when_to_visit,
                            }}
                        ></div>
                        <div
                            className={`text-[#1A2A44] text-[16px] lg:text-[18px] prose ${
                                tab === "accessibility" ? "" : "hidden"
                            }`}
                            dangerouslySetInnerHTML={{
                                __html: city.content_accessibility,
                            }}
                        ></div>
                    </div>
