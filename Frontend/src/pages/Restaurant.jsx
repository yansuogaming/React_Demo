...
const PostCard = ({ image, title, date, desc, large = false }) => (
    <div className={large ? "lg:col-span-2 group" : "group"}>
        ...
        <h3
            className={`${large ? "text-[24px] font-bold" : "text-[20px] font-semibold"
                } text-[#1A2A44] mt-4`}
        >
...
const RestaurantCard = ({ image, title, desc, link = "#" }) => (
    <div
    ...
    >
        ...
        <div className="group w-full h-full relative">
            ...
            {/* Title */}
            <div
                className={`absolute bottom-0 left-0 w-full p-6 text-white transition-all duration-500 ${desc ? "group-hover:pb-20" : "group-hover:pb-10"
                    }`}
            >
...
const Restaurant = () => {
    ...
    const breadcrumdItems = [
        { label: t("home"), href: "/" },
        { label: t("Restaurant"), href: "/" },
        { label: "VietISO Restaurant", href: "/" },
    ];
            ...
            <section className="container mx-auto px-4">
                ...
                <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
                    {["Keyword", "Category", "Region"].map((label, idx) => (
                        <div
                            key={label}
                            className={`flex flex-col w-full ${label === "Region"
                                    ? "max-w-[162px]"
                                    : "max-w-[351px]"
                                }`}
                        >
                ...
                <div className="flex justify-center mt-[40px] gap-[5px] items-center">
                    ...
                    >
                        <FaChevronLeft
                            className={`mr-[16px] ${currentPage === 1
                                    ? "text-[#D9D9D9]"
                                    : "text-[#1A2A44]"
                                }`}
                        />
                    ...
                    {Array.from({ length: totalPages }, (_, i) => (
                        <button
                            ...
                            className={`w-[50px] h-[50px] flex items-center justify-center border rounded text-[16px] font-[500] cursor-pointer ${currentPage === i + 1
                    ...
                    >
                        <FaChevronRight
                            className={`ml-[16px] ${currentPage === totalPages
                                    ? "text-[#D9D9D9]"
                                    : "text-[#1A2A44]"
                                }`}
                        />
                ...
                <div className="mt-[175px]">
                    ...
                    <RestaurantSlider data={RestaurantFakeData} />
                </div>
            </section>
