                ...
                <div className="flex items-center justify-between gap-[26px]">
                    ...
                    >
                        <svg
                            ...
                            className="!w-[24px] !h-[24px]"
                        >
                            <g clipPath="url(#clip0_536_2423)">
                                <path
                                    d="M19.2487 0C17.7559 0.103249 16.0112 1.05874 14.9944 2.30299C14.0669 3.43173 13.3039 5.10822 13.6014 6.73746C15.2324 6.78821 16.9177 5.80997 17.8942 4.54472C18.8077 3.36698 19.4989 1.70099 19.2487 0Z"
                                    fill="black"
                                />
                                <path
