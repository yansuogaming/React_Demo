...
const CreateItineraryButton = ({ className = "" }) => {
    ...
    return (
        <button
            className={`cursor-pointer flex gap-[8px] md:gap-[18px] bg-[#007BFF] rounded-[33px] p-[15px_48px] lg:p-[16px_50px] text-[18px] lg:text-[22px] text-white font-[700] ${className}`}
        >
