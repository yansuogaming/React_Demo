...
const Header = ({ noBackgroundOnScroll = false }) => {
    ...
    const [hoverExperiencesContent, setHoverExperiencesContent] =
        useState(false);
            ...
            <header>
                ...
                >
                    ...
                    <ExperiencesContent
                        ...
                        className={
                            hoverExperiences || hoverExperiencesContent
                                ? "flex"
                                : "hidden"
                        }
                    />
                    <DestinationsContent
                        ...
                        className={
                            hoverDestinations || hoverDestinationsContent
                                ? "flex"
                                : "hidden"
                        }
                    />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8  py-8  border-t border-gray-100 ">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <InfoCard
                        ...
                        title={t("Regions")}
                        description={t(
                            "Discover the charm of Northern Vietnam"
                        )}
                        icon={
                            <ChevronRight color="black" className="h-5 w-5" />
                        }
                    ...
                    <InfoCard
                        ...
                        description={t(
                            "Experience Southern Vietnam's vibrancy"
                        )}
                        icon={
                            <ChevronRight color="black" className="h-5 w-5" />
                        }
