  ...
  return (
    <HeaderContext.Provider value={contextValue}>
      <header>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center w-full relative xl-md:w-fit h-full ">
              ...
              <motion.div
                ...
                transition={
                  noBackgroundOnScroll ? { duration: 0.7, delay: 0.2 } : false
                }
                className="mr-[50px]"
              >
                <NavLink to="/">
              ...
              >
                <motion.li
                  initial={
                    noBackgroundOnScroll ? { opacity: 0, y: -100 } : false
                  }
                  animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                  transition={
                    noBackgroundOnScroll ? { duration: 0.7, delay: 0.3 } : false
                  }
                ...
                <motion.li
                  ...
                  animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                  transition={
                    noBackgroundOnScroll ? { duration: 0.7, delay: 0.4 } : false
                  }
                  className="p-[15px] h-fit"
                  onMouseEnter={() =>
                ...
                <motion.li
                  ...
                  animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                  transition={
                    noBackgroundOnScroll ? { duration: 0.7, delay: 0.5 } : false
                  }
                  className="p-[15px] h-fit"
                >
                ...
                <motion.li
                  ...
                  animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                  transition={
                    noBackgroundOnScroll ? { duration: 0.7, delay: 0.6 } : false
                  }
                  className="p-[15px] h-fit "
                  onMouseEnter={() =>
                ...
                <motion.li
                  ...
                  animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                  transition={
                    noBackgroundOnScroll ? { duration: 0.7, delay: 0.7 } : false
                  }
                  className="p-[15px] h-fit"
                >
            ...
            <ul className="items-center font-bold hidden xl-md:flex ">
              <motion.li
                ...
                animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                transition={
                  noBackgroundOnScroll ? { duration: 0.7, delay: 0.8 } : false
                }
              >
                <SearchHeader
                  color={color}
              ...
              <motion.li
                ...
                animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                transition={
                  noBackgroundOnScroll ? { duration: 0.7, delay: 0.9 } : false
                }
              >
              ...
              <motion.li
                ...
                animate={noBackgroundOnScroll ? { opacity: 1, y: 0 } : false}
                transition={
                  noBackgroundOnScroll ? { duration: 0.7, delay: 1 } : false
                }
              >
        ...
        <ModalSearch isOpen={showSearch} onClose={() => setShowSearch(false)} />
      </header>
