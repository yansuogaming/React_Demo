    ...
    return (
        <div className="flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {item.list_nearbys?.map((place, index) => (
                                <button
                                    ...
                                    key={index}
                                    className={`flex gap-3 p-3 rounded-md ${selectedMarker?.potential_id === place?.potential_id? "bg-[#343e58]" : "bg-gray-800"}`}
                                >
            ...
            {item?.list_images && item.list_images.length > 0 && (
                <div className="mt-4">
                    <h4 className="text-lg font-medium text-white mb-2 ml-2">
                        {t("images")}
                    </h4>
