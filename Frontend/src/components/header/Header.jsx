...
const Header = ({ noBackgroundOnScroll = false }) => {
    return (
        <HeaderProvider noBackgroundOnScroll={noBackgroundOnScroll}>
            <HeaderContent noBackgroundOnScroll={noBackgroundOnScroll} />
        </HeaderProvider>
    );
};

const HeaderContent = ({ noBackgroundOnScroll = false }) => {
