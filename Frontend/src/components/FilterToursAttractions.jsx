...
const FilterToursAttractions = ({ className = "", data = [] }) => {
    ...
    return (
        <section
            className={`container ${className} flex flex-col gap-4 sm:gap-6 lg:gap-[30px] items-center lg:items-end`}
        >
            <MenuFilter />
    ...
    return (
        <div>
            <div className="w-full lg:w-auto">
                ...
                <div>
                    <p className="text-base sm:text-[18px] font-bold mb-3 sm:mb-[16px]">
                        Duration
                    </p>
                ...
                <img
                    src={advertising}
                    alt="Advertising"
                    className="w-full mt-4 sm:mt-[32px] rounded-[8px]"
                />
            </div>
        </div>
    );
...
const TourItem = ({ item, index }) => {
    ...
    return (
        <>
                ...
                <div className="mt-3 sm:mt-4 md:mt-0 md:ml-[19px] flex-1 flex flex-col justify-between">
                    <div>
                        ...
                        <div className="flex flex-row items-center justify-between">
                            <h3 className="text-base sm:text-lg md:text-[20px] font-bold text-[#1D2D53] group-hover:text-blue-500">
                                {item.name}
                            </h3>
								...
								{item.video_url && (
									<a
										...
										className={cn(
											...
											'rounded-3xl px-2 py-1 text-xs',
											'sm:text-sm text-[#1A2A44]'
										)}
									>
										Video
									</a>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between">
                            <div className="flex flex-col gap-2 sm:gap-2">
                                <div className="flex items-start gap-2">
									<MapPin className="w-3 h-3 sm:w-4 sm:h-4 mt-1 text-gray-600 flex-shrink-0" />
									<div>
										<span className="text-xs sm:text-[14px] text-[#1A2A44]">
											{item.address}
										</span>
									</div>
								</div>
								<div className="flex items-start gap-2">
									<Clock className="w-3 h-3 sm:w-4 sm:h-4 mt-1 text-gray-600 flex-shrink-0" />
									<div>
										<span className="text-xs sm:text-[14px] text-[#1A2A44]">
											Open now
										</span>
            ...
            {index === 8 && (
                <img
                    className="hidden sm:flex w-full max-w-[950px] rounded-[8px]"
